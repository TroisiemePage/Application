...
export default class CarteSVG extends React.Component {
    ...
    render() {
        let highlightingCircleRadius = this.state.circleRadius.interpolate({
            inputRange: [0, 1],
            outputRange: ["40", "45"]
        });
        return(
                ...
                <G >
                    <G transform="matrix(0.275378,0,0,0.275378,70.853,496.758)">
                        <G id="chemin" transform="matrix(0.691754,0,0,0.691754,-210.641,-1920.55)" fill="none"
                           strokeWidth="4">
                            <G currentLevel="2" stroke={this.props.currentLevel >= 2 ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="4" stroke={this.props.currentLevel >= 4 ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="5" stroke={this.props.currentLevel >= 5  ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="6" stroke={this.props.currentLevel >= 6  ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="7" stroke={this.props.currentLevel >= 7  ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="8" stroke={this.props.currentLevel >= 8 ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="9" stroke={this.props.currentLevel >= 9  ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="10" stroke={this.props.currentLevel >= 10 ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="11" stroke={this.props.currentLevel >= 11 ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="12" stroke={this.props.currentLevel >= 12 ? this.achieved : this.toExplore}>
                            ...
                            <G currentLevel="13" stroke={this.props.currentLevel >= 13 ? this.achieved : this.toExplore}>
                            ...
                            <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                <G transform="matrix(1,0,0,1,807.358,962.739)">
                                    <AnimatedEllipse
                                        cx="-48.549"
                                        cy="0.002"
                                        rx={highlightingCircleRadius}//"48.548"
                                        ry={highlightingCircleRadius} //"48.549"
                        ...
                        <G id="cercles" transform="matrix(4.24458,0,0,4.24458,-249.065,-2120.79)" strokeWidth="4"
                           fill="rgb(253,250,234)">
                            <G currentLevel="1" stroke={this.props.currentLevel >= 1 ? this.achieved : this.toExplore}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,494.453,962.739)">
                                        <Path
                                            ...
                                            fill={this.props.currentLevel == 1 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                                ...
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,807.358,962.739)">
                                        <Path
                                            ...
                                            fill={this.props.currentLevel == 2 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                            <G currentLevel="3" stroke={this.props.currentLevel >= 3 ? this.achieved : this.toExplore}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,895.577,831.331)">
                                        <Path
                                            ...
                                            fill={this.props.currentLevel == 3 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                                ...
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,1280.41,729.999)">
                                        <Path
                                            ...
                                            fill={this.props.currentLevel == 4 ? this.achieved : this.backgroundColor }
                                        />
                                    </G>
                                </G>
                            </G>
                                ...
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,1531.88,583.879)">
                                        <Path
                                            ...
                                            fill={this.props.currentLevel == 5 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                                ...
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,1640.94,583.879)">
                                        <Path
                                            ...
                                            fill={this.props.currentLevel == 6 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                            <G currentLevel="7" stroke={this.props.currentLevel >= 7 ? this.achieved : this.toExplore}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,1750,583.879)">
                                        <Path
                                            d="M0,0.001C0,12.401 -10.053,22.454 -22.452,22.454C-34.854,22.454 -44.906,12.401 -44.906,0.001C-44.906,-12.4 -34.854,-22.453 -22.452,-22.453C-10.053,-22.453 0,-12.4 0,0.001"
                                            fill={this.props.currentLevel == 7 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                            <G currentLevel="8" stroke={this.props.currentLevel >= 8 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(0.905408,0,0,0.905408,1686.17,794.502)">
                                    <Path
                                        d="M0,0.001C0,12.401 -10.053,22.454 -22.452,22.454C-34.854,22.454 -44.906,12.401 -44.906,0.001C-44.906,-12.4 -34.854,-22.453 -22.452,-22.453C-10.053,-22.453 0,-12.4 0,0.001"
                                        fill={this.props.currentLevel == 8 ? this.achieved : this.backgroundColor}
                                    />
                                </G>
                            </G>
                            <G currentLevel="9" stroke={this.props.currentLevel >= 9 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,710.999,1123.88)">
                                        <Path
                                            d="M0,0.002C0,12.402 -10.053,22.454 -22.452,22.454C-34.854,22.454 -44.906,12.402 -44.906,0.002C-44.906,-12.399 -34.854,-22.452 -22.452,-22.452C-10.053,-22.452 0,-12.399 0,0.002"
                                            fill={this.props.currentLevel == 9 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                            <G currentLevel="10" stroke={this.props.currentLevel >= 10 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,497.878,1501.29)">
                                        <Path
                                            d="M0,0.002C0,12.402 -10.053,22.454 -22.452,22.454C-34.854,22.454 -44.906,12.402 -44.906,0.002C-44.906,-12.399 -34.854,-22.452 -22.452,-22.452C-10.053,-22.452 0,-12.399 0,0.002"
                                            fill={this.props.currentLevel == 10 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                            <G currentLevel="11" stroke={this.props.currentLevel >= 11 ? this.achieved : this.toExploreLighter} >
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,873.999,1501.38)">
                                        <Path
                                            d="M0,0.002C0,12.402 -10.053,22.454 -22.452,22.454C-34.854,22.454 -44.906,12.402 -44.906,0.002C-44.906,-12.399 -34.854,-22.452 -22.452,-22.452C-10.053,-22.452 0,-12.399 0,0.002"
                                            fill={this.props.currentLevel == 11 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                            <G currentLevel="12" stroke={this.props.currentLevel >= 12 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,1225,1501.38)">
                                        <Path
                                            d="M0,0.002C0,12.402 -10.053,22.454 -22.452,22.454C-34.854,22.454 -44.906,12.402 -44.906,0.002C-44.906,-12.399 -34.854,-22.452 -22.452,-22.452C-10.053,-22.452 0,-12.399 0,0.002"
                                            fill={this.props.currentLevel == 12 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                            <G currentLevel="13" stroke={this.props.currentLevel >= 13 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,47.2954)">
                                    <G transform="matrix(1,0,0,1,1613.94,1505.12)">
                                        <Path
                                            d="M0,0.002C0,12.402 -10.053,22.454 -22.452,22.454C-34.854,22.454 -44.906,12.402 -44.906,0.002C-44.906,-12.399 -34.854,-22.452 -22.452,-22.452C-10.053,-22.452 0,-12.399 0,0.002"
                                            fill={this.props.currentLevel == 13 ? this.achieved : this.backgroundColor}
                                        />
                                    </G>
                                </G>
                            </G>
                        ...
                        <G id="nombres" transform="matrix(4.24458,0,0,4.24458,-249.065,-2120.79)" fontSize="25"
                           fontWeight="500">
                            <G currentLevel="1" stroke={this.props.currentLevel >= 1 ? this.achieved : this.toExplore}>
                                <G transform="matrix(0.905408,0,0,0.905408,9.07626,57.2954)">
                            ...
                            <G currentLevel="10" stroke={this.props.currentLevel >= 10 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(1,0,0,1,-37.0962,-82.6021)">
                            ...
                            <G currentLevel="11" stroke={this.props.currentLevel >= 11 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(1,0,0,1,-78.3831,-87.6382)">
                            ...
                            <G currentLevel="12" stroke={this.props.currentLevel >= 12 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(1,0,0,1,-108.22,-87.23)">
                            ...
                            <G currentLevel="13" stroke={this.props.currentLevel >= 13 ? this.achieved : this.toExploreLighter}>
                                <G transform="matrix(1,0,0,1,-144.004,-81.6984)">
